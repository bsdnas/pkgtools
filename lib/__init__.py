...
#
# Имя продукта. Оно не косметическое: из него вычитается длина при
# формировании имени загрузочной среды (Update.py):
#
#     new_boot_name = Version()[len(Avatar() + "-"):]
#
# При _os_type = "TrueNAS" и версии "BSDnas-15-MASTER-202608122140" от
# версии отрезалось восемь символов вместо семи, и среда получала имя
# "TrueNAS-5-MASTER-202608122140" — с чужой маркой и обрезанным номером.
# Проверено на живом обновлении через поезд.
_os_type = "BSDnas"
